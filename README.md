...
## si eres de otro pais ciudad (en mi caso para verificar que me llegaba correctamente en Postman para verificar los datos correctamente) coge otros datos quee te interesen, cogi los datos que se me      ## mostraban en postman y puse la url weatheapi y añadi e ${apikey} poniendo la 
